...
def main():
    ...
    try:
        ...
        rvr.drive_rc_normalized(
            linear_velocity=50,  # Valid linear velocity values are -127..127
            yaw_angular_velocity=10,  # Valid angular velocity values are -127..127
            flags=0
        )
        ...
        rvr.drive_rc_normalized(
            linear_velocity=40,         # Valid linear velocity values are -127..127
